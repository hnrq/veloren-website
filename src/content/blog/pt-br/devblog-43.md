...
guid: "https://veloren.net/blog/devblog-43/"
url: "https://veloren.net/blog/devblog-43/"
pubDate: "2019-11-25T00:00:00.000Z"
---
...
![mountain](https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/523568428905398283/647407674551435275/unknown.png)
...
However, the downside is that explicit numerical methods do not converge to the same solution if you make the time step large enough Each of them has a certain range of time steps where they are "stable" and this varies by algorithm. If you're applying lots of different methods like this (as you often do for things like erosion), you are limited by the shortest convergence time scale of any of the methods In practice, this time scale is sometimes measured in years, or even days. While we need to simulate erosion over millions of years to get realistic looking landscapes.

![village](https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/634860358623821835/647786679066689536/screenshot_1574514737131.png)

The more recent innovations that have allowed these techniques to scale to large areas and time periods have thus been in finding clever implicit algorithms for solving these problems. In each iteration, an implicit algorithm computes values for all the cells "at once". This is done by solving partial differential equations, either exactly or using numerical methods with guaranteed convergence rates per iteration. The downside is that these equations are much more complex, and often require global information and ordering of the solution that makes them difficult to parallelize.
...
![river-valley](https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/450064928720814081/648317007762161665/screenshot_1574641016614.png)

_A river at the bottom of a valley_
...
![tectonic](https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/450064928720814081/648306318213644300/Screen_Shot_2019-11-25_at_12.32.41_AM.png)

_Tectonic uplift map_
...
![mountain](https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/450064928720814081/648317020735143938/screenshot_1574641007838.png)

_Mountains off in the distance_
...
![loading-screen](https://s3.eu-central-2.wasabisys.com/veloren-blog/cdn/523568428905398283/647479114621648896/screenshot_1574441428637.png)

_The new loading screen by @Pfau. See you next week!_